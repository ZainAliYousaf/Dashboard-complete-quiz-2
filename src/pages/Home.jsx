  ...
  return (
    <>
      ...
      <section className="info-section">
        <h2>Why Choose Our WeatherApp?</h2>
        <p className="info-desc">
          Our weather app delivers accurate, up-to-date information designed to
          keep you informed wherever you are. Built with the latest technology,
          it’s fast, intuitive, and visually appealing — ensuring you never get
          caught unprepared.
        </p>
        ...
        <div className="info-cards">
          <div className="info-card">
            ...
            <p>
              Automatically detects your current city and provides weather data
              with temperature, humidity, and air quality in real time.
            </p>
          </div>
          <div className="info-card">
            ...
            <p>
              Get detailed forecasts for the upcoming week — plan your trips or
          ...
          <div className="info-card">
            ...
            <p>
              Receive instant alerts for rain, storms, or extreme temperatures
